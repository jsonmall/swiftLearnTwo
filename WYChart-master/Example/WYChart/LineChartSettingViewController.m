...
- (instancetype)init {
    ...
    if (self) {
        _parameters = [NSMutableDictionary dictionaryWithObjectsAndKeys:@2.0, kLineChartAnimationDuration,
                       @(kWYLineChartAnimationWidth), kLineChartAnimationStyle,
...
- (NSMutableDictionary *)getLineAttributesAtIndex:(NSUInteger)index {
    ...
    while (lineAttributes.count <= index) {
        [lineAttributes addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:@(kWYLineChartMainStraightLine), kLineChartLineStyle,
